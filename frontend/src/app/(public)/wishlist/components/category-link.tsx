      ...
      {categories?.data.map((item: CategoryReadBasic) => {
        ...
        return (
          <button
            key={item.id}
            onClick={() => {
              set_wishlist_category(item.category_name);
...
export default WishlistCategoryLink;
