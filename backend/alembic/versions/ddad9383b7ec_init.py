...
Revision ID: ddad9383b7ec
Revises:
Create Date: 2026-09-01 09:20:33.389655
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "side_images", sa.ARRAY(sa.String()), server_default="{}", nullable=False
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "payment_status",
            sa.Enum("PAID", "UNPAID", name="payment_status"),
            nullable=False,
        ),
        sa.Column(
            "payment_method",
