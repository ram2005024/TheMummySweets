...
Revision ID: 7b11f1471a6c
Revises: 
Create Date: 2026-09-13 11:05:19.829021
...
def upgrade() -> None:
    ...
    sa.Column('grouped_unit', sa.Enum('ltr', 'ml', 'pcs', 'na', name='quantizedunit'), nullable=False),
    ...
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.Column('updated_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.CheckConstraint("(grouped_unit = 'na' AND grouped_quantity = 0) OR (grouped_unit IN ('pcs','ml','ltr') AND grouped_quantity > 0)", name='grouped_quantity_positive_for_unit'),
