...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "ingredients", sa.ARRAY(sa.String()), server_default="{}", nullable=False
        ),
        sa.Column("stock_quantity", sa.Integer(), nullable=False),
        sa.Column(
            "main_image", postgresql.JSONB(astext_type=sa.Text()), nullable=False
        ),
        sa.Column(
            "side_images", postgresql.JSONB(astext_type=sa.Text()), nullable=False
        ),
        ...
        sa.CheckConstraint(
            "(grouped_unit = 'na' AND grouped_quantity = 0) OR (grouped_unit IN ('pcs','ml','ltr') AND grouped_quantity > 0)",
